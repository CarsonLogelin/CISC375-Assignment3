//import { setStorage, createStorage, loadStorage } from "./modules/storage";
import {addSettingsListeners,  changePalette} from "./modules/settings";
import { modifyString, getContrastColor } from "./misc";
...
function createGrid() {
    ...
    let current_storage = loadStorage(puzzles, loaded_puzzle);
    let x = 0;
    let y = 0;
...
function buttonClick(button) {
    let current_data = loadStorage(puzzles, loaded_puzzle);
    ...
    if(current_data[storage_index]=='0' && button.dataset.c == selected_color) {
        ...
        setStorage(current_data, puzzles, loaded_puzzle);
        updateProgress();
